...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start = findViewById(R.id.dbtn_start);
        btn_answer0 = findViewById(R.id.dbtn_answer0);
        btn_answer1 = findViewById(R.id.dbtn_answer1);
        btn_answer2 = findViewById(R.id.dbtn_answer2);
        btn_answer3 = findViewById(R.id.dbtn_answer3);

        tv_score = findViewById(R.id.dtv_score);
        tv_bottommessage = findViewById(R.id.dtv_bottommessage);
        tv_questions = findViewById(R.id.dtv_questions);
        tv_timer = findViewById(R.id.dtv_timer);
